...
export const WebsiteFooter: React.FC = () => {
  ...
  return (
    <footer
      id="about"
      className="relative z-30 bg-[#08090A] overflow-visible"
      style={{
        width: '100vw',
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8 md:gap-12 pt-2 pb-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="relative inline-block select-none cursor-pointer group mb-2">
              <div className="bg-[#E5BD00] text-[#090A0B] font-sans font-black text-xl sm:text-2xl px-4 py-1.5 rounded-sm border-[2.5px] border-[#090A0B] shadow-[3px_3px_0px_#090A0B] -rotate-1 tracking-wider flex items-center justify-center group-hover:scale-105 transition-transform">
                <span>ZINNIA</span>
                <span className="text-[#D51F55] ml-1.5">'26</span>
              </div>
              <div className="w-0 h-0 border-t-[8px] border-t-[#E5BD00] border-l-[8px] border-l-transparent border-r-[4px] border-r-transparent ml-3 -mt-0.5" />
            </div>
